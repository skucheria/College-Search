//
//  NavigationPracticeViewController.m
//  Project
//
//  Created by Siddharth Kucheria on 7/26/15.
//  Copyright (c) 2015 Siddharth Kucheria. All rights reserved.
//

#import "NavigationPracticeViewController.h"
#import <Parse/Parse.h>


@interface NavigationPracticeViewController ()
@property (nonatomic, strong) NSMutableIndexSet *optionIndices;


@end

@implementation NavigationPracticeViewController
...
- (void)viewDidLoad {
    ...
    /*
    UIImage *menuImage = [UIImage imageNamed:@"medical50.png"];//[UIColor colorWithRed:0.88 green:0.40 blue:0.40 alpha:1.0]
    
//    UIBarButtonItem *sidBar = [UIBarButtonItem
   UIButton *menuButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [menuButton setFrame:CGRectMake(20,20, 25, 25)];
    [menuButton setBackgroundImage:menuImage forState:UIControlStateNormal];
    [menuButton addTarget:self.navigationController.parentViewController action:@selector(onBurger:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)sidebar:(RNFrostedSidebar *)sidebar didTapItemAtIndex:(NSUInteger)index {
    ...
    if(index==1){
        ...
        UIViewController *settings=[mainstoryboard instantiateViewControllerWithIdentifier:@"ProfileViewController"];
